...
#dictionary whose keys are bit strings that represent outputs of the circuit,
#and the values represent the number of shots for which this output occurred
